 ...
 * @author jonat
 */
public class SecretaryApproveDelete extends javax.swing.JFrame {

    private Secretary secretary;
    /**
     * Creates new form SecretaryApproveDelete
     */
    public SecretaryApproveDelete() {
        initComponents();
        fillList();
    }
    public SecretaryApproveDelete(Secretary secretary) {
        initComponents();
    ...
    private void fillList(){
        ...
        ArrayList<HospitalPeople> allPatients = secretary.getRemovalUsers();
        if (allPatients != null) {
    ...
    private void initComponents() {
        ...
        lblHome.setText("Approve Account termination");
        ...
        if (allPatients != null) {
            for (HospitalPeople person : allPatients) {
                if (person.getUsername().equals(accountName)) {
                    SecretaryController.terminateAccount(secretary, person);
                    fillList();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SecretaryApproveDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SecretaryApproveDelete().setVisible(true);
            }
        });
    }
